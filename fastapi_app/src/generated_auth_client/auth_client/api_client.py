...
from auth_client.exceptions import ApiTypeError, ApiValueError, ApiException
from auth_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.auth_admin_v1_change_role_post  # this is an instance of the class Endpoint
        api_instance.auth_admin_v1_change_role_post()  # this invokes api_instance.auth_admin_v1_change_role_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.auth_admin_v1_change_role_post.callable or self.callable in this class
